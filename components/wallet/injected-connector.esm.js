import { AbstractConnector } from "./abstract-connector.esm";
...
var InjectedConnector = /*#__PURE__*/ (function (_AbstractConnector) {
  ...
  function InjectedConnector(kwargs) {
    ...
    _this3.handleChainChanged = _this3.handleChainChanged.bind(
      _assertThisInitialized(_this3)
    );
    _this3.handleAccountsChanged = _this3.handleAccountsChanged.bind(
      _assertThisInitialized(_this3)
    );
    _this3.handleClose = _this3.handleClose.bind(
      _assertThisInitialized(_this3)
    );
    return _this3;
  }
        ...
        var _temp = (function () {
          if (!account) {
            ...
            return Promise.resolve(
              window.ethereum.enable().then(function (sendReturn) {
  ...
  _proto.getChainId = function getChainId() {
    try {
        ...
        function _temp9() {
          ...
          if (!chainId) {
            if (window.ethereum.isDapper) {
              chainId = parseSendReturn(
                window.ethereum.cachedResults.net_version
              );
            } else {
              chainId =
        ...
        var _temp8 = (function () {
          if (!chainId) {
            var _temp12 = _catch(
              function () {
                return Promise.resolve(
                  window.ethereum.send("net_version").then(parseSendReturn)
                ).then(function (_window$ethereum$send3) {
      ...
      var _temp14 = _catch(
        function () {
          return Promise.resolve(
            window.ethereum.send("eth_chainId").then(parseSendReturn)
          ).then(function (_window$ethereum$send2) {
      ...
      return Promise.resolve(
        _temp14 && _temp14.then ? _temp14.then(_temp13) : _temp13(_temp14)
      );
    } catch (e) {
      return Promise.reject(e);
    }
  ...
  _proto.getAccount = function getAccount() {
    try {
      var _temp21 = function _temp21() {
        ...
        return _temp16 && _temp16.then
          ? _temp16.then(_temp17)
          : _temp17(_temp16);
      };
      ...
      var _temp22 = _catch(
        function () {
          return Promise.resolve(
            window.ethereum.send("eth_accounts").then(function (sendReturn) {
              return parseSendReturn(sendReturn)[0];
            })
      ...
      return Promise.resolve(
        _temp22 && _temp22.then ? _temp22.then(_temp21) : _temp21(_temp22)
      );
    } catch (e) {
      return Promise.reject(e);
    }
